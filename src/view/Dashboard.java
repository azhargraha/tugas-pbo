...
public class Dashboard extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(628, 540));
        ...
        if (ongoingServiceTable.getColumnModel().getColumnCount() > 0) {
            ongoingServiceTable.getColumnModel().getColumn(0).setResizable(false);
            ongoingServiceTable.getColumnModel().getColumn(1).setResizable(false);
            ongoingServiceTable.getColumnModel().getColumn(4).setResizable(false);
            ongoingServiceTable.getColumnModel().getColumn(5).setResizable(false);
        }
